...
<header class="header-top">
	...
	<div class="col-12 text-center">
		<br>
		<h2>NOMURA 22AW last delivery</h2>
	</div>
    <div class="col-12 text-center">
		<br>
		<p>2022 01-23</p>
    ...
    <div class="col-12 text-center">
        <img src="../img/BLOG/nomurablog.jpg" alt="" width="500" height="600"></img>
    </div>
    <div class="row">
        <div class="col-lg-3 col-sm-6">
        </div>
        <div class="col-lg-6 col-sm-6 text-center">
            <p>とてつもなくイカしたアイテムだけに色々商品の魅力について語りたいところですがそれはちゃんと写真撮ってからにいたします！<br><br>

			気になるかたはお先に店頭でご覧いただけるので直接お試しくださいませ。</p>
