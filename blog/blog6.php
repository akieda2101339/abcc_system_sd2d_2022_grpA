...
<header class="header-top">
    ...
    <div class="col-12 text-center">
        <img src="../img/BLOG/nakamurablog.jpg" alt="" width="500" height="550"></img>
    </div>
    <div class="row">
        <div class="col-lg-3 col-sm-6">
        </div>
        <div class="col-lg-6 col-sm-6 text-center">
            <p>NAKAMURAのスタンダードラインからニュースタンダードニットカーディガンです。<br><br>
                ウールナイロンの温かみのある素材を発色の良い色味に仕上げております。<br><br>
                サイズ感は従来のシルエットよりゆとりを持たせていてリラックス感のある着用感に！！
                
                このお手頃プライスも見過ごせないですね！！</p>
